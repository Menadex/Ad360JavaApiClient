...
import com.ad360.api.auth.ApiKeyAuth;
import com.ad360.api.auth.Authentication;
import com.ad360.api.auth.HttpBasicAuth;
import com.ad360.api.auth.OAuth;

@SuppressWarnings("rawtypes")
public class ApiClient {
  protected Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  protected String basePath = "https://api.ad360.media/v1";
  ...
  public ApiClient(String basePath) {
    ...
    authentications.put("Ad360ClientAuth", new HttpBasicAuth());
    authentications.put("CognitoAuth", new ApiKeyAuth("header", "Authorization"));
    authentications.put("SearchLogAuthorizer", new ApiKeyAuth("header", "Authorization"));
